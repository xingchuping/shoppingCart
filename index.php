...
<html>
	<head>
		...
		<title>手机购物车列表页静态网页模板 - 我爱模板网 www.5imoban.net</title>
	...
	<body style="max-width:640px; margin:0 auto;">
	    ...
	    <div class="content-list" id="outer">
	    	<!-- <div class="list-left" id="tab">
	    		<li class="current"><a style="position: relative;">新品推荐<i class="num">8</i></a></li>
	    		<li><a>芝士奶盖系列</a></li>
	    		<li><a>精选奶茶</a></li>
	    		<li><a>部落奶盐</a></li>
	    		<li><a>正宗可可奶盖</a></li>
	    	...
	    	<div class="list-right" id="content">
	    		<ul class="list-pro">	    		<?php 	    		 if(!empty($data)) {	    		     foreach ($data as $value ) {	    		 ?>	    		         <li>	    		         	    		         <a href="detail.html"><img src="<?php echo $value[cover] ?>" class="list-pic" /></a>	    		         	    		         <div class="shop-list-mid">	    		         	    		         <div class="tit"><a><?php echo $value[title] ?></a></div>	    		         	    		         <div class="am-gallery-desc">￥<?php echo $value['price'] ?></div>	    		         	    		         </div>	    		         	    		         <div class="list-cart">	    		         	    		         <div class="d-stock ">	    		         	    		         <a class="decrease">-</a>	    		         	    		         <input id="num" readonly="" class="text_box" name="" type="text" value="<?php echo $value['num'] ?>">	    		         	    		         <a class="increase">+</a>	    		         	    		         </div>	    		         	    		         </div>	    		         	    		         </li>	    		<?php	    		     }	    		 }	    		?>
